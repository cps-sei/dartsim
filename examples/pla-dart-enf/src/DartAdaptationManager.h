...
struct DartMonitoringInfo {
	dart::sim::Coordinate position;
	int altitudeLevel; /**< current altitude of the team */
...
public:
	 ...
	 */
	void initialize(const Params& params, std::unique_ptr<pladapt::UtilityFunction> missionUtilityFunction,
...
protected:
	...
	std::unique_ptr<pladapt::UtilityFunction> pSurvivalUtilityFunction;
