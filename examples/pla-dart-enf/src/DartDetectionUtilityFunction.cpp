...
DartDetectionUtilityFunction::DartDetectionUtilityFunction(double targetDetectionRange, double detectionFormationFactor,
 ...
 */
double DartDetectionUtilityFunction::getAdditiveUtility(
 ...
 */
double DartDetectionUtilityFunction::getMultiplicativeUtility(
		const pladapt::Configuration& config, const pladapt::Environment& env,
		int time) const {
...
double DartDetectionUtilityFunction::getFinalReward(
		const pladapt::Configuration& config, const pladapt::Environment& env,
		int time) const {
	return finalReward;
}
...
double DartDetectionUtilityFunction::getProbabilityOfDetection(const DartConfiguration& config) const {
...
double DartDetectionUtilityFunction::getProbabilityOfDestruction(const DartConfiguration& config) const {
...
DartDetectionUtilityFunction::~DartDetectionUtilityFunction() {
}
